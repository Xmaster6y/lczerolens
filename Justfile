...
tests-slow:
	uv run --group dev --group notebooks --extra hub --extra datasets --extra viz --extra backends pytest tests -m 'slow or integration' --cov=src --cov-report=term-missing -s -v
